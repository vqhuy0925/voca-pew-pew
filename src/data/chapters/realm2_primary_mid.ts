...
export const REALM2_REALM: AgeRealm = {
  id: 'realm-2',
  realmNumber: 2,
  rankCode: 'SPACE_SCOUT',
  name: 'Space Scout Galaxy',
  nameVi: 'Trinh Sát Thiên Hà',
  cefrLevel: 'A1',
  recommendedAge: 'Khuyên dùng: 8 - 10 Tuổi hoặc Đã Qua Cấp Độ 1',
  ageRange: '8 - 10 Tuổi',
  gradeLabel: 'CEFR A1 (Trinh Sát Không Gian)',
