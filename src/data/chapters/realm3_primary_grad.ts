...
export const REALM3_REALM: AgeRealm = {
  id: 'realm-3',
  realmNumber: 3,
  rankCode: 'ASTRO_RANGER',
  name: 'Astro Ranger Belt',
  nameVi: 'Chiến Binh Thiên Hà',
  cefrLevel: 'A2',
  recommendedAge: 'Khuyên dùng: 10 - 12 Tuổi hoặc Đã Qua Cấp Độ 2',
  ageRange: '10 - 12 Tuổi',
  gradeLabel: 'CEFR A2 (Chiến Binh Sao)',
