...
export const REALM1_REALM: AgeRealm = {
  ...
  realmNumber: 1,
  rankCode: 'STAR_CADET',
  name: 'Star Cadet Academy',
  nameVi: 'Học Viện Tân Binh Sao',
  cefrLevel: 'Pre-A1',
  recommendedAge: 'Khuyên dùng: 6 - 8 Tuổi hoặc Tân Binh Mới Bắt Đầu',
  ageRange: '6 - 8 Tuổi',
  gradeLabel: 'Pre-A1 (Tân Binh Vũ Trụ)',
  description: '25 Chương khởi động với từ vựng nền tảng 3-5 chữ cái, tốc độ gõ nhẹ nhàng, hình ảnh sinh động thân thiện.',
  icon: '🌱',
  color: '#00f0ff',
