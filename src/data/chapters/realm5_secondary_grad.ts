...
export const REALM5_REALM: AgeRealm = {
  id: 'realm-5',
  realmNumber: 5,
  rankCode: 'COSMOS_COMMANDER',
  name: 'Cosmos Commander Sector',
  nameVi: 'Chỉ Huy Không Gian',
  cefrLevel: 'B2',
  recommendedAge: 'Khuyên dùng: 14 - 16 Tuổi hoặc Trình độ B2',
  ageRange: '14 - 16 Tuổi',
  gradeLabel: 'CEFR B2 (Chỉ Huy Không Gian)',
  description: '40 Chương chuyên sâu với từ vựng 7-12 chữ cái, phản xạ gõ nhanh, chính xác và tư duy học thuật.',
  icon: '🔮',
  color: '#8b5cf6',
