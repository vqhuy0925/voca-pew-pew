  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleClick}
        disabled={!isUnlocked}
        className={`relative w-20 h-20 sm:w-24 sm:h-24 rounded-full flex flex-col items-center justify-center font-game font-bold transition-all duration-150 select-none ${
          isUnlocked
